...
import { SwitchGroup } from "@soft-ui/react/switch-group"
import { SwitchGroupItem } from "@soft-ui/react/switch-group-item"
import { SwitchPrefix } from "@soft-ui/react/switch-prefix"
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-[var(--space-48)] px-[var(--space-16)] py-[var(--space-32)] md:px-[var(--space-24)]">
      ...
      <section className="flex flex-col gap-[var(--space-20)]">
        <CodeBlock
          code={`import { SwitchGroup } from "@soft-ui/react/switch-group"
import { SwitchGroupItem } from "@soft-ui/react/switch-group-item"
