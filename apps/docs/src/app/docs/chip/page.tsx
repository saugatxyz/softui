...
import { Chip } from "@soft-ui/react/chip"
import { ChipGroup } from "@soft-ui/react/chip-group"
import { ChipPrefix } from "@soft-ui/react/chip-prefix"
import { StarFillIcon, HeartFillIcon, CheckCircleIcon, SpamFillIcon } from "@soft-ui/icons"
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-[var(--space-48)] px-[var(--space-16)] py-[var(--space-32)] md:px-[var(--space-24)]">
      ...
      <section className="flex flex-col gap-[var(--space-20)]">
        <CodeBlock
          code={`import { Chip, ChipGroup } from "@soft-ui/react/chip"
import { ChipPrefix } from "@soft-ui/react/chip-prefix"
import { StarFillIcon } from "@soft-ui/icons"
