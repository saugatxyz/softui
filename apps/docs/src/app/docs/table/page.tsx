...
import { Table, type SortDirection } from "@soft-ui/react/table"
import { IconButton } from "@soft-ui/react/icon-button"
import { Avatar } from "@soft-ui/react/avatar"
import { type LogoType } from "@soft-ui/react/logo"
import { type CryptoType } from "@soft-ui/react/crypto"
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-[var(--space-48)] px-[var(--space-16)] py-[var(--space-32)] md:px-[var(--space-24)]">
      ...
      <section className="flex flex-col gap-[var(--space-10)]">
        <CodeBlock
          code={`import { Table } from "@soft-ui/react/table"
