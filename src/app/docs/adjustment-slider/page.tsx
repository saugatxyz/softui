...
import { SunFillIcon, ContrastFillIcon, VolumeFillIcon } from "@/icons"
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-[var(--space-48)] px-[var(--space-16)] py-[var(--space-32)] md:px-[var(--space-24)]">
      ...
      <section className="flex flex-col gap-[var(--space-20)]">
        <CodeBlock
          code={`import { AdjustmentSlider } from "@/components/ui/adjustment-slider"
import { SunFillIcon } from "@/icons"
