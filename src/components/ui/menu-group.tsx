...
function MenuGroupLabel({ className, children, ...props }: MenuGroupLabelProps) {
  return (
    <Menu.GroupLabel
      ...
      className={cn(
        "flex min-h-[28px] items-center px-[var(--space-12)] py-[var(--space-6)] text-[length:var(--font-size-xs)] font-[var(--font-weight-medium)] leading-[var(--line-height-xs)] text-content-subtle",
        className
      )}
      {...props}
    >
